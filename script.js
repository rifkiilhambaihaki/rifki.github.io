...
function optionSelected(answer) {
  ...
  if (userAnswer == correctAnswer) {
    ...
    // jika jawaban salah, auto muncul jawaban benar
  ...
  // jika user telah memilih, semua opsi menghilang
  for (let i = 0; i < allOptions; i++) {
...
function showResultBox() {
  ...
  scoreText.textContent = `Jawaban benar ${userScore} dari ${questions.length}`;
